<div class="row">
    <div class="resume-container col-md-12">
        <div class="section_header">                        
            <input class="resume_id" type="hidden" value="57 ">
            <input class="employer_id" type="hidden" value="1 ">  
            <h1 class="title resume-title">Roy Al Pane</h1>
            <div class="space"></div>
            <div class="row">
                <div class="col-md-4">
                    <div class="application-job">
                        <div>
                            <div class="resume-pic-container">
                                <div class="space"></div>
                                <img class="resume-pic img-thumbnail" width="150" height="150" src="//vidhire.net/wp-content/uploads/2014/10/man-3.jpg" class="attachment-thumbnail wp-post-image" alt="man 3">
                            </div>
                            <div class="space"></div>
                            <ul>
                                <li>
                                    Minimum Hourly Rate: <strong>23 CAD</strong> 
                                </li>
                                <li>
                                    Desired Position Type: <strong>Any</strong>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <ul>
                                <li> 
                                    ...
                                    &nbsp;
                                    <strong>
                                        <a href="mailto:test@emial.com?subject=Your Resume on VidHire">test@emial.com</a>
                                    </strong>
                                </li>
                                <li ><i class="fa fa-phone"></i>&nbsp;<strong>123456</strong></li>
                                <li ><i class="fa fa-mobile"></i>&nbsp;<strong>123456</strong></li>
                                <li ><i class="fa fa-skype"></i>&nbsp;<a href="skype:&lt;strong&gt;tmcgregor&lt;/strong&gt;">tmcgregor</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="ead-document">
                                    <iframe src="//view.officeapps.live.com/op/embed.aspx?src=http%3A%2F%2Fvidhire.net%2Fwp-content%2Fuploads%2Fresume_files%2F2015%2F03%2FSample-Resume-Computer-Programmer-Entry-Level1.doc" style="width:100%; height:895px; border: none;"></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="degree-section">
                        <div class="degree-section-text-section">
                            ...
                            <div class="su-box-content">
                                <div class="space"></div>
                                <ul>
                                    <li>Bachelor of Science in Information Technology,Harvard,1995</li>
                                </ul>
                                <ul>
                                    <li>
                                        <label>Last year's overall average: </label>70% – 80%
                                    </li><li><label>Transcripts:</label>Yes
                                    </li>
                                </ul>
                                <a href="http://vidhire.net/wp-content/uploads/misc_documents/2015/03/CERTIFICATE_FOR_EMPLOYMENT_Test.png" target="_blank">
                                    <img width="150" height="150" src="//vidhire.net/wp-content/uploads/misc_documents/2015/03/CERTIFICATE_FOR_EMPLOYMENT_Test-150x150.png" class="attachment-thumbnail" alt="CERTIFICATE_FOR_EMPLOYMENT_Test.jpg">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-5">
                    <div class="skills-container">
                        <div class="skills-text">
                            ...
                            <div class="su-box-content">
                                <ul>
                                    <li><a class="tags">C++</a>   </li>
                                    <li><a class="tags">C#</a></li>
                                    <li><a class="tags">flash</a></li>
                                    <li><a class="tags">HTML</a></li>
                                    <li><a class="tags">Illustrator</a></li>
                                    <li><a class="tags">java</a></li>
                                    <li> <a class="tags">JQuery</a></li>
                                    <li><a class="tags">Photoshop</a></li>
                                    <li><a class="tags">PHP</a></li>
                                    <li> <a class="tags">SQL</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="career-map-table"> 
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong>Lead Program Developer</strong></td><td><strong>Lead Programmer</strong></td><td><strong>Lead Systems Designer</strong></td>
                                    </tr>

                                    <tr>
                                        <td nowrap=""><strong>Start Date</strong></td>
                                        <td>Jan 12 2010</td><td>Jun 12 2006</td><td>Jul 01 2000</td>
                                    </tr>
                                    <tr>
                                        <td nowrap=""><strong>End Date</strong></td>
                                        <td>Jan 08 2015</td><td>Nov 12 2009</td><td>Jul 01 2005</td>
                                    </tr>

                                    <tr>
                                        <td nowrap=""><strong>Job Type</strong></td>
                                        <td>Full-Time</td><td>Full-Time</td><td>Full-Time</td>
                                    </tr>

                                    <tr>
                                        <td nowrap=""><strong>Company</strong></td>
                                        <td>Clarin LTD</td><td>Qsiere Inc</td><td>Rames Inovations INC</td>
                                    </tr>
                                    <tr>
                                        <td nowrap=""><strong>City</strong></td>
                                        <td>Toronto</td><td>Whitby</td><td>Toronto</td>
                                    </tr>
                                    <tr>
                                        <td nowrap=""><strong>Country</strong></td>
                                        <td>Canada</td><td>Canada</td><td>Canada</td>
                                    </tr>
                                    <tr>
                                        <td nowrap=""><strong>Reason for Leaving</strong></td>
                                        <td>Career change</td><td>Career change</td><td>Good career opportunity</td>
                                    </tr>
                                    <tr>
                                        <td class="space"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="user_salary"><strong>57</strong>&nbsp;CAD</td><td class="user_salary"><strong>38</strong>&nbsp;CAD</td><td class="user_salary"><strong>32</strong>&nbsp;CAD</td>
                                    </tr>

                                    <tr>
                                        <td nowrap=""><strong>Final Salary</strong></td>
                                        <td class="user_salary"><strong>68</strong>&nbsp;CAD</td><td class="user_salary"><strong>48</strong>&nbsp;CAD</td><td class="user_salary"><strong>38</strong>&nbsp;CAD</td>
                                    </tr>

                                    <tr>
                                        <td nowrap=""><strong>Salary Type</strong></td>
                                        <td class="user_salary">Per Hour</td><td class="user_salary">Per Hour</td><td class="user_salary">Per Month</td>
                                    </tr>
                                    <tr>
                                        <td class="space"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="reference_name"><strong>Steven Jones</strong></td><td class="reference_name"><strong>John Horvath</strong></td><td class="reference_name"><strong>Nancy Drew</strong></td>
                                    </tr><tr>
                                        <td nowrap=""><strong>Position/Title</strong></td>
                                        <td>Division Head</td><td>Human Resources</td><td>CEO</td></tr><tr>
                                        <td nowrap=""><strong>Reference Email</strong></td>
                                        <td><a class="noscroll reference_email" href="#">jones@fatcat.com</a></td><td><a class="noscroll reference_email" href="#">jon@fdsfds.com</a></td><td><a class="noscroll reference_email" href="#">nancy@fdsfds.com</a></td>
                                    </tr><tr>
                                        <td nowrap=""><strong>Reference Phone</strong></td>
                                        <td>9073456789</td><td>4324324324232</td><td>8980980890</td>
                                    </tr><tr>
                                        <td nowrap=""><strong>Notes</strong></td>
                                        <td>Division Head and good friend.                                      </td><td>Human Resources Notes</td><td>CEO NOtes</td>
                                    </tr><tr class="request_reference_button_holder">
                                        <td nowrap="" style="border: 0px;background: transparent;">&nbsp;</td>
                                        <td style="border: 0px;"><input type="button" class="email-reference btn btn-primary" value="Request Reference"></td>
                                        <td style="border: 0px;"><input type="button" class="email-reference btn btn-primary" value="Request Reference"></td>
                                        <td style="border: 0px;"><input type="button" class="email-reference btn btn-primary" value="Request Reference"></td>
                                    </tr>
                                </tbody>
                    ...
                    <div class="location">
                        ...
                        <div class="su-box-content su-clearfix">                                    
                            <div id="geolocation_box">
                                <p>
                                    <input type="hidden" class="hidden" name="jr_address" id="geolocation-address" value="Oshawa, Ontario, Canada">
